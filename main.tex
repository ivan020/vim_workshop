...
\begin{frame}{VimTips}
    ...
    \begin{itemize}
        ...
        \item \highlight{dip} delete a token, stay in normal mode after.
        \item \highlight{cip} delete a token and enter the editing mode.
        \item \highlight{daP} delets a token and its surrounding to the next token.
        \item \highlight{caP} deletes a token and its surrounding to the next token, entering the edit mode.
